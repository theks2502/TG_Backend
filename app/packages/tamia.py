...
from app.utils.mail.tamia import  send_booking_email_tamia
import shutil, os
...
@router.post("/tamia" , status_code=status.HTTP_201_CREATED)
async def tamia_package(background_tasks: BackgroundTasks , 
        full_name : str = Form(...) ,
        ...
        db.commit() 
        db.refresh(details)
        background_tasks.add_task(send_booking_email_tamia, details, file_location)
